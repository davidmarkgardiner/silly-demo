...
az aks create -g $RG -n $AKS --network-plugin azure --network-plugin-mode overlay  --kubernetes-version "1.28" --node-count 1 --enable-asm --generate-ssh-key

az aks get-credentials --name $AKS -g $RG --overwrite-existing --admin --file .kube-$AKS
...
k get all -n aks-istio-system -l app=istio-ingressgateway
k get all -n aks-istio-system -l app=istio-ingressgateway -o yaml
k get all -n aks-istio-system -l app=istio-ingressgateway -o yaml | grep -i service.beta.kubernetes.io/azure-load-balancer-internal

k get pods -n aks-istio-system
